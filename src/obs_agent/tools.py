        ...
        "a fresh child session in the new topic.",
        {
            ...
            "model": {
                ...
                "description": (
                    ...
                    "local 32K window fail loudly rather than falling back. A daemon configured with "
                    "OBS_LOCAL_LLM_BASE_URL plus OBS_LOCAL_LLM_AUTH_TOKEN or OBS_LOCAL_LLM_API_KEY can "
                    "launch a local alias without putting credentials in the AgentTask request. "
                    "'inherit' or omitted = use "
